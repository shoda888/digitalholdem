$(document).ready(function() {
  ...
  $('#d12').dblclick(function(){
    $(this).attr('src','/d12.png');
  });
  $('#d13').dblclick(function(){
  ...
  $('#h7').dblclick(function(){
    $(this).attr('src', '/h7.png');
  });
  $('#h8').dblclick(function(){
  ...
  $('#h11').dblclick(function(){
    $(this).attr('src', '/h11.png')
  });
  $('#h12').dblclick(function(){
    $(this).attr('src','/h12.png');
  });
  $('#h13').dblclick(function(){
